...
container.addEventListener("mouseup", () => {  // removing mousemove listener on mousemove event
...
speedOptions.querySelectorAll("li").forEach(option => {
    option.addEventListener("click", () => {         // adding click event on all speed option
        ...
        option.classList.add("active");  // adding active on the selected option
    })
});
...
mainVideo.addEventListener("play", () => {   // if video is play, change to pause
    playPauseBtn.classList.replace("fa-play", "fa-pause");
});

mainVideo.addEventListener("pause", () => {   // if video is pause, change to play
